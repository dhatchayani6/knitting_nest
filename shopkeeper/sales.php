                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        <tr>
                            ...
                            rows = `<tr><td colspan="8" class="text-danger text-center">No sales found</td></tr>`;
                        }
                        $('#fetch_sales').html(rows);
                    },
                    error: function () {
                        $('#fetch_sales').html(`<tr><td colspan="8" class="text-danger text-center">Error fetching sales</td></tr>`);
                    }
                });
            }

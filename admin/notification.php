                    ...
                    <div class="container mt-4">
                        ...
                        <script>
                            ...
                            function fetchNotifications() {
                                ...
                                if (!container) return; // Ensure we are on notifications page

                                $.ajax({
                                    url: 'api/fetch_low_stock.php',
                                    type: 'GET',
                                    dataType: 'json',
                                    success: function (data) {
                                        ...
                                        if (data.length > 0) {
                                            ...
                                            data.forEach(item => html += `<li>${item.message} (Shop: ${item.shop_name})</li>`);
                                            html += '</ul></div>';
                                            container.html(html);
                                            ...
                                            container.html('<div class="alert alert-success mt-3">All items are sufficiently stocked.</div>');
